...
# nlist=3000: ~1k vectors per cluster; nprobe=8 scans ~8k vectors — better recall, similar latency.
# With 16 CPUs at build time this takes ~2-3min.
RUN ./build-index -resources ./resources -nlist 3000 -iterations 15
